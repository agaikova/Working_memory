...
class Working_Memory(ctn_benchmark.Benchmark):
    def params(self):
        ...
        self.default('input_scale', input_scale = 0.38314316705290097)
        self.default('n_neurons_per_dim', n_neurons_per_dim = 50)
        
        self.default('intercept_low', intercept_low = -0.4989080091138938)
        self.default('intercept_high', intercept_high = 0.5963158879085206)
        self.default('tau_input', tau_input = 0.009683186948674292)
        self.default('tau_recurrent', tau_recurrent = 0.1959772077772586)
        self.default('tau_reset', tau_reset = 0.1376503648029975)
        self.default('max_rate_high', max_rate_high = 225.01822297425895)
        self.default('max_rate_low', max_rate_low = 130.69268975236358)
