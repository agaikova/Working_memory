...
class Working_Memory(ctn_benchmark.Benchmark):
    def params(self):
        ...
        self.default('input_scale', input_scale = 0.3833780061255102)
        self.default('n_neurons_per_dim', n_neurons_per_dim = 50)
        
        self.default('intercept_low', intercept_low = -0.4992744299277808)
        self.default('intercept_high', intercept_high = 0.809991052831423)
        self.default('tau_input', tau_input = 0.013502354155587815)
        self.default('tau_recurrent', tau_recurrent = 0.19573723138942678)
        self.default('tau_reset', tau_reset = 0.07956492225081398)
        self.default('max_rate_high', max_rate_high = 197.19119519297644)
        self.default('max_rate_low', max_rate_low = 119.17285810399966)
